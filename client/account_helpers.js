if (Meteor.isClient) {
    ...
    UI.registerHelper('accountButtons', function() {
        return Template.A6sViewButtons;
    });
    ...
    UI.registerHelper('signupClass', function() {
        if (A6s.settings.showOtherLoginServices && Accounts.oauth && Accounts.oauth.serviceNames().length > 0) {
            return "collapse";
        }
    });
    ...
    UI.registerHelper('otherLoginServices', function() {
        return A6s.settings.showOtherLoginServices && Accounts.oauth && Accounts.oauth.serviceNames().length > 0;
    });
    ...
    UI.registerHelper('showSignupCode', function() {
        return A6s.settings.showSignupCode === true;
    });
